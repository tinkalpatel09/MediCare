...
public class MedicineActivity extends AppCompatActivity implements View.OnClickListener, ValueEventListener {
    ...
    private void popup() {
        ...
        final TextView textViewStartDate=(TextView)mView.findViewById(R.id.textViewStartDate);
        ...
        btnConfirm.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Medicine medicine = new Medicine(Datee,medicineName,frequency,dosage,meal,days,endDate);
